...
struct SOCPythonVisitor : public boost::python::def_visitor<SOCPythonVisitor<SOC> > {
  ...
  void visit(PyClass &cl) const {
    cl.def(bp::init<>("Default constructor."))
        ...
        .def("check", (bool (SOC::*)(const VectorD &) const) & SOC::check, bp::arg("vector"),
             "Checks if the vector given in argument belongs to the conic constraint.")
        .def("check", (bool (SOC::*)(const VectorD &, const Scalar) const) & SOC::check, bp::args("vector", "factor"),
             "Checks if the vector given in argument belongs to the conic constraint with a given reduction factor.")
        ...
        .def("isApprox", (bool (SOC::*)(const SOC &, const Scalar &) const) & SOC::isApprox, bp::args("other", "prec"),
             "Returns true if *this is approximately equal to other, within the precision determined by prec.")
        .def(bp::self == bp::self)
        .def(bp::self != bp::self)

        .def("RegularCone", &SOC::RegularCone, bp::args("mu", "direction"),
             "Creates a regular cone from a given friction coefficient and a direction.")
