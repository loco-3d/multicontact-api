...
struct ContactPhasePythonVisitor : public bp::def_visitor<ContactPhasePythonVisitor<ContactPhase> > {
  ...
  void visit(PyClass& cl) const {
    cl.def(bp::init<>(bp::arg(""), "Default constructor."))
        ...
        .add_property("timeFinal", &getTimeFinal, &setTimeFinal, "The time at the end of this contact phase.")
        .add_property("duration", &getDuration, &setDuration, "The duration this contact phase.")
        // expose public members :
        .add_property("c_init",
                      bp::make_getter(&ContactPhase::m_c_init, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_c_init),
                      "Initial 3D position of the center of mass for this contact phase")
        .add_property("dc_init",
                      bp::make_getter(&ContactPhase::m_dc_init, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_dc_init),
                      "Initial linear velocity of the center of mass for this contact phase")
        .add_property("ddc_init",
                      bp::make_getter(&ContactPhase::m_ddc_init, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_ddc_init),
                      "Initial linear acceleration of the center of mass for this contact phase")
        .add_property("L_init",
                      bp::make_getter(&ContactPhase::m_L_init, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_L_init), "Initial angular momentum for this contact phase")
        .add_property(
            "dL_init", bp::make_getter(&ContactPhase::m_dL_init, bp::return_value_policy<bp::return_by_value>()),
            bp::make_setter(&ContactPhase::m_dL_init), "Initial angular momentum derivative for this contact phase")
        .add_property("q_init",
                      bp::make_getter(&ContactPhase::m_q_init, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_q_init), "Initial whole body configuration of this phase")
        .add_property("c_final",
                      bp::make_getter(&ContactPhase::m_c_final, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_c_final),
                      "Final 3D position of the center of mass for this contact phase")
        .add_property("dc_final",
                      bp::make_getter(&ContactPhase::m_dc_final, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_dc_final),
                      "Final linear velocity of the center of mass for this contact phase")
        .add_property("ddc_final",
                      bp::make_getter(&ContactPhase::m_ddc_final, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_ddc_final),
                      "Final linear acceleration of the center of mass for this contact phase")
        .add_property("L_final",
                      bp::make_getter(&ContactPhase::m_L_final, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_L_final), "Final angular momentum for this contact phase")
        .add_property(
            "dL_final", bp::make_getter(&ContactPhase::m_dL_final, bp::return_value_policy<bp::return_by_value>()),
            bp::make_setter(&ContactPhase::m_dL_final), "Final angular momentum derivative for this contact phase")
        .add_property("q_final",
                      bp::make_getter(&ContactPhase::m_q_final, bp::return_value_policy<bp::return_by_value>()),
                      bp::make_setter(&ContactPhase::m_q_final), "Final whole body configuration of this phase")
        ...
        .def("contactPatches", &contactPatchesAsDict, "Return a CONST dict EffectorName:ContactPatch")
        .def("contactForces", &contactForcesAsDict, "Return a CONST dict EffectorName:contact force")
        ...
        .def("addContactForceTrajectory", &ContactPhase::addContactForceTrajectory,
        ...
        .def("addContactNormalForceTrajectory", &ContactPhase::addContactNormalForceTrajectory,
             bp::args("effector_name", "trajectory"),
        ...
        .def("removeContact", &ContactPhase::removeContact, bp::arg("effector_name"),
             ...
             "This will also remove the contact_patch, all the contact_forces and contact_normal_forces related to "
             "this contact.\n"
        ...
        .def("effectorHaveAtrajectory", &ContactPhase::effectorHaveAtrajectory, bp::arg("effector_name"),
             "Returns True if the given effector_name have an effector_trajectory defined in this phase, False "
             "otherwise.")
        .def(
            "effectorsWithTrajectory", &effectorsWithTrajectoryAsList,
