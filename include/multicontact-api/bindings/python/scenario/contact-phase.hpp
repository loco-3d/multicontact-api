...
struct ContactPhasePythonVisitor : public boost::python::def_visitor<ContactPhasePythonVisitor<ContactPhase> > {
  ...
  void visit(PyClass& cl) const {
    cl.def(bp::init<>(bp::arg(""), "Default constructor."))
        ...
        .add_property("sowc", bp::make_function(&getSOWC, bp::return_internal_reference<>()), &setSOWC,
                      "Second order conic constraint representing the Wrench Cone of contact forces of the patches.")

        .add_property("sowc_placement", bp::make_function(&getSOWCPlacement, bp::return_internal_reference<>()),
                      &setSOWCPlacement, "Returns the placement of the SDWC.")

        .add_property("double_description", &getDoubleDescription, &setDoubleDescription,
                      "Returns the double description of the LWC.")

        .add_property("lwc", bp::make_function(&getLWC, bp::return_internal_reference<>()), &setLWC,
