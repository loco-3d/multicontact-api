...
/*
  ...
  */
  ...
  BOOST_CHECK(cp3.m_wrench != curve);
  cp5 = cp3;
  BOOST_CHECK(cp5 == cp3);
  curve = buildRandomPolynomial3D();
  cp5.m_zmp = curve;
  ...
  BOOST_CHECK(cp3.m_root != curveSE3);
  cp5 = cp3;
  BOOST_CHECK(cp5 == cp3);
  // check serialization
